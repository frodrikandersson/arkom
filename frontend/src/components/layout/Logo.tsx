...
export const Logo = () => {
  return (
    <Link to="/" className={styles.logo} aria-label="Arkom Home">
      <svg width="120" height="32" viewBox="0 0 120 32" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Arkom Logo">
        <title>Arkom</title>
